...
使用者在下载、使用、修改或分发本仓库内容时，须严格遵守所在地法律法规。任何由于使用本项目内容造成的网络、账户、经济或法律问题，均由使用者自行承担，作者概不负责。  

若仓库内容存在侵权、违规或影响他人权益的部分，请通过 Issue 或邮箱联系我，我将及时处理与删除。使用即代表您已充分阅读、理解并同意本免责声明的全部条款。
